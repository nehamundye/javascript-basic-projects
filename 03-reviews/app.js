...
randomBtn.addEventListener('click', function() {
    ...
    author.textContent = reviews[randomNumber]['name']
    job.textContent = reviews[randomNumber]['job']
    info.textContent = reviews[randomNumber]['text']
});
...
prevBtn.addEventListener('click', function() {
    // console.log(`prevBtn_initialItem: ${initialItem}`)
    if (initialItem === 0) {
...
nextBtn.addEventListener('click', function() {
    // console.log(`nextBtn_initialItem: ${initialItem}`)
